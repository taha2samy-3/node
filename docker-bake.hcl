...
variable "BASE_IMAGE" {
  default = "cgr.dev/chainguard/wolfi-base@sha256:1d95114038f76513a9ace6fca107d5582b08c65981f81f61cb56bf7fd2ef216d"
}
...
variable "PYTHON_3_13_FULL_VERSION" { default = "3.13.15_git20260917-r0" }
variable "PYTHON_3_14_FULL_VERSION" { default = "3.14.7_git20260917-r3" }
